...
pause
%windir%\system32\wscript.exe //Nologo ..\tools\Storage\functions\open_file.vbs "" "Fichier de jeu Switch (*.xci;*.nsp;*.xciz;*.nspz)|*.xci|*.nsp|*.xciz|*.nspz|" "Sélection du jeu à compresser/décompresser" "templogs\tempvar.txt"
